...
namespace tongtastic\AdobeSign\Tests;
...
class AdobeSignTest extends BaseTestCase
{
    ...
    {
        $this->expectException('tongtastic\AdobeSign\Exceptions\AdobeSignInvalidAccessTokenException');
    ...
    {
        $this->expectException('tongtastic\AdobeSign\Exceptions\AdobeSignUnsupportedMediaTypeException');
    ...
    {
        $this->expectException('tongtastic\AdobeSign\Exceptions\AdobeSignMissingRequiredParamException');
    ...
    {
        $this->expectException('tongtastic\AdobeSign\Exceptions\AdobeSignException');
